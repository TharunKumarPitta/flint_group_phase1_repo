...
/**
 * This is the extension manager of the Flintyb2bsaporderfulfillment extension.
 */
public class Flintyb2bsaporderfulfillmentManager extends GeneratedFlintyb2bsaporderfulfillmentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Flintyb2bsaporderfulfillmentManager.class.getName());
	 ...
	 */
	public static Flintyb2bsaporderfulfillmentManager getInstance()
	{
		return (Flintyb2bsaporderfulfillmentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Flintyb2bsaporderfulfillmentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Flintyb2bsaporderfulfillmentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Flintyb2bsaporderfulfillmentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Flintyb2bsaporderfulfillmentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Flintyb2bsaporderfulfillmentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
