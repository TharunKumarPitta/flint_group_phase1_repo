...
import com.flintgroup.constants.ActionIds;
...
public class OrderCancelRepairJob extends AbstractJobPerformable<CronJobModel>
{
	...
	private static final String YSAPORDERFULFILLMENT_REPAIR_JOB_CANCEL_MINUTES = "flintyb2bsaporderfulfillment.repair.job.cancel.minutes";
	...
	public PerformResult perform(final CronJobModel arg0)
	{
		...
		waitProcesses = orderExchangeRepair.findProcessesByActionIds(Flintyb2bsaporderfulfillmentConstants.ORDER_PROCESS_NAME, new String[]
