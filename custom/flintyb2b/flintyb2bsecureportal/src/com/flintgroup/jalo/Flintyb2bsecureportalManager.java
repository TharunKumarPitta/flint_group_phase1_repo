...
/**
 * This is the extension manager of the Flintyb2bsecureportal extension.
 */
public class Flintyb2bsecureportalManager extends GeneratedFlintyb2bsecureportalManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Flintyb2bsecureportalManager.class.getName());
	 ...
	 */
	public static Flintyb2bsecureportalManager getInstance()
	{
		return (Flintyb2bsecureportalManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Flintyb2bsecureportalConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Flintyb2bsecureportalManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Flintyb2bsecureportalManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Flintyb2bsecureportalManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Flintyb2bsecureportalManager called, current tenant: " + getTenant().getTenantID());
		}
	}
