...
import com.flintgroup.constants.Flintyb2bbackofficeConstants;
 ...
 */
public class Flintyb2bbackofficeManager extends GeneratedFlintyb2bbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Flintyb2bbackofficeManager.class.getName());
	 ...
	 */
	public static Flintyb2bbackofficeManager getInstance()
	{
		return (Flintyb2bbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Flintyb2bbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Flintyb2bbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Flintyb2bbackofficeManager called.");
		}
	}
