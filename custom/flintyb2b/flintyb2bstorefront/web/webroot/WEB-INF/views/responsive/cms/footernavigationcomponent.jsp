...
<div class="container-fluid">
 ...
 --%>
					...
					<!--<div class="footer__nav--container col-xs-12 col-sm-2">
						<ul class="footer__nav--links">
							<li> <a href="http://www.flintgrp.com/en/contact/" target="_blank"><spring:theme code="general.inquiries"/> </a> </li>
						</ul>
					</div>-->
				...
				<!--	<div class="footer__nav--container col-xs-12 col-sm-2">
						<ul class="footer__nav--links">
							<li> <a href="http://www.flintgrp.com/en/privacy-note/" target="_blank"><spring:theme code="privacy.policy"/> </a> </li>
						</ul>
					</div> -->
