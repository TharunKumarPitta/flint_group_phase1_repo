	 ...
	 <div class="container-fluid main-order">
          ...
          <div class="wel-come-mark col-md-4 col-sm-6 col-xs-4"> <spring:theme code="header.welcome" arguments="${user.firstName},${user.lastName}" htmlEscape="true" /></div>
            <div class="col-md-2 col-sm-3 col-xs-4 img-head-top">
              <img class="cust-img" src="${commonResourcePath}/images/dashboard-icon1.png">
                <span class="icon-font-order"><a class="ancor-ref" href="">Quick Order</a></span>
            </div>
            <div class="col-md-2 col-sm-3 col-xs-4 img-head-top">
              <img class="cust-img" src="${commonResourcePath}/images/dashboard-icon2.png">
                <span class="icon-font-order"><a class="ancor-ref" href="${request.contextPath}/c/flintCategory">Product Catalog</a></span>
            </div>
      </div>
        ...
        <div class="col-sm-12 order-manage-part">
            <div class="col-sm-6 order-history-part">
              <div class="tab-head-history col-sm-12">
                <div class="table-header-history">Recent Order history</div>
              </div>
              <table class="table">
                <thead>
                  <tr class="tab-font">
                ...
                <tbody>
                  ...
                  <td class="table-link" style="border-top-style: none;"></td>
                  <td class="table-link" style="border-top-style: none;"><a href="my-account/orders">All Order history</a></td></tr>
                </tbody>
              </table>
            </div>
            <div class="col-sm-6 order-history-part">
              <div class="tab-head-history col-sm-12">
              <div class="table-header-history">Recent Support Tickets</div>
            </div>
              <table class="table">
                <thead>
                <tr class="tab-font">
                ...
                <tbody>
                  ...
                  <td class="table-link" style="border-top-style: none;"></td>
                  <td class="table-link" style="border-top-style: none;"></td>
                  <td class="table-link" style="border-top-style: none;"><a href="">All Support tickets</a></td></tr>
                </tbody>
              </table>
      ...
      <div class="col-sm-4 col-xs-4 image-part">
        <div class="text-img-flint">
          <div class="flint-gp">Flint Group's Global<br>
            Inovation Centre
          </div>
          <div class="flint-gic">
            See how our GIC specialist in Malmo
            <br>are delivering solutions to meet
            <br>your needs.</br>
          </div> 
        </div>
        <img src="${commonResourcePath}/images/dashboard-image.png">
      </div>
  </div>
	<script>
