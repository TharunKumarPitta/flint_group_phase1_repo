...
import com.flintgroup.constants.Flintyb2bcustomerticketingConstants;



/**
 * This is the extension manager of the Flintyb2bcustomerticketing extension.
 */
public class Flintyb2bcustomerticketingManager extends GeneratedFlintyb2bcustomerticketingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Flintyb2bcustomerticketingManager.class.getName());
	 ...
	 */
	public static Flintyb2bcustomerticketingManager getInstance()
	{
		return (Flintyb2bcustomerticketingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Flintyb2bcustomerticketingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Flintyb2bcustomerticketingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Flintyb2bcustomerticketingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Flintyb2bcustomerticketingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Flintyb2bcustomerticketingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
