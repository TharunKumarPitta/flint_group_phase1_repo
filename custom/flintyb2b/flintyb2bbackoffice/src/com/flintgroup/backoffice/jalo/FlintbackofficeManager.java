 ...
 */
public class FlintbackofficeManager extends GeneratedFlintbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FlintbackofficeManager.class.getName());
	 ...
	 */
	public static FlintbackofficeManager getInstance()
	{
		return (FlintbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(FlintbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FlintbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FlintbackofficeManager called.");
		}
	}
